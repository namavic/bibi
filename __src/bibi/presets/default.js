...
"use-loupe-buttons"          : "desktop", // "yes" or "no" or "desktop" or "mobile" (Note: Loupe buttons will not appear in touch-devices even if it is set "yes" or "mobile".)
...
"use-bookmark-button"        : "yes", // "yes" or "no" or "desktop" or "mobile"
"max-bookmarks"              : 3, // Number (0-9). If larger than 9, treated as 9. If 0, "use-bookmark-button" and "use-bookmarks" are treated as "no" (but old data is kept in localStorage). 

"use-history-button"         : "yes", // "yes" or "no" or "desktop" or "mobile". (history-button requires the slider.)
"max-histories"              : 19, // Number (0-19). If larger than 19, treated as 19. If 0, "use-history-button" and "use-histories" are treated as "no".
