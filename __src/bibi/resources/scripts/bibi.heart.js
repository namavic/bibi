...
S.initialize = () => {
    ...
    // --------
    if(S['headless']) S['use-menubar'] = S['use-arrows'] = S['use-slider'] = S['use-nombre'] = S['use-fontsize-changer'] = S['use-bookmark-button'] = S['use-history-button'] = S['use-loupe-buttons'] = false;
    // --------
    ...
    if(!S['use-histories']) S['max-histories'] = 0, S['use-history-button'] = false;
    if(!O.Biscuits || S['max-bookmarks'] == 0) S['use-bookmarks'] = false;
    if(!S['use-bookmarks']) S['max-bookmarks'] = 0, S['use-bookmark-button'] = false;
    // --------
